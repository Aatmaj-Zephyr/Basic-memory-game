...
for(let i=WordLength-1;i>0;i--){
    WordLetters.push("_"); 
    //Push blank underscores in the rest of the array according t the length of the word.
}
...
//Number of turns left. Modify the formulae in the later versions.
...
for (var k of Word){ 
    if(!(Letters.includes(k))&k!=Word.charAt(0)){
       ...
       //Push the letters of word into the "Letters" array without repeatition
    }
}
...
Letters.push(Letters[0]);//Ignore the card at 0th positon
for(let f=1;f<=16;f++){
...
//a is the parameter which tells which button is clicked.
    ...
    checkscore(a); //Check the Letters.
    }
